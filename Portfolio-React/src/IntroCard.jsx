  ...
  return (
    <div className="IntroCard">
      ...
      <section class="socialMedia">
        <span id="linkedIn">
          <a href="https://www.linkedin.com/in/sarahbethlocklar/">
            <svg
        ...
        <span id="gitHub">
          <a href="https://github.com/SBLOCKLAR">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
        ...
        <span id="stackOverflow">
          <a href="https://stackoverflow.com/users/21120518/sarah-beth-locklar">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
